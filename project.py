...
data = data.head(10)
data
#%%  BAR GRAPH OF MARKET CAPITALIZATION OF THE TOP 10 SEMICONDUCTOR COMPANIES
import pandas as pd
import matplotlib.pyplot as plt
...
#%%  NVIDIA STOCKS OF MAY 2024
import pandas as pd 
import matplotlib.pyplot as plt
data = pd.read_csv(r"NVDA (1).csv")
data.iloc[6359:6381]
#%%  LINE GRAPH OF NVIDIA STOCKS OF MAY 2024
import pandas as pd
import matplotlib.pyplot as plt
data = pd.read_csv(r"NVDA (1).csv")
...
#%%  OHLC CHART OF NVIDIA STOCKS OF MAY 2024
import pandas as pd
